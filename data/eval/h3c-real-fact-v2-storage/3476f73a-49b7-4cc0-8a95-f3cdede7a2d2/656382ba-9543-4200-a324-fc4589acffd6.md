...
<head>
    ...
    <meta name="keywords" content="智慧医院解决方案" />
    <meta name="description" content="建设背景我国通过一系列的政策和标准的发布推动新医改不断落地和实施，伴随着城乡居民的医疗支出的增加，人民对更高品质的医疗服务有了更多需求，云计算、大数据、物联网、人工智能等新技术的发展带动医疗行业发展和升级。智慧医院的建设也成为趋势，多元化、综合化、智能化也" />
    <meta name="author" content="新华三集团" />
    <meta name="Copyright" content="www.h3c.com,版权所有,不得随意转载" />
    <meta name="CNPT" content="行业解决方案" />
    <meta name="SSFL" content="医疗" />
    <title>智慧医院解决方案-新华三集团-H3C</title>
            ...
            <div class="container">
                <div class="row prolist_container">
                    <div class="par_left col-xs-12 col-sm-9 col-md-9">
                        <div class="article">
                            <DIV style="DISPLAY: none" data-longurl="/cn/IndustrySolution/Medical/Solution/202208/1664075_961592_0.htm"></DIV>
<DIV id=newsContentHead class=clearFix>
<DIV class=subNewsTitle>
<H1>智慧医院解决方案</H1>
<!-- content Begin -->
<DIV style="FONT-SIZE: 12px; COLOR: #999999; TEXT-ALIGN: right; LINE-HEIGHT: 24px; MARGIN-RIGHT: 20px">【发布时间：2022-08-11】</DIV>
<DIV id=detailBody class=detailBody><DIV><H2>建设背景</H2><P class=MsoNormal>我国通过一系列的政策和标准的发布推动新医改不断落地和实施，伴随着城乡居民的医疗支出的增加，人民对更高品质的医疗服务有了更多需求，云计算、大数据、物联网、人工智能等新技术的发展带动医疗行业发展和升级。智慧医院的建设也成为趋势，多元化、综合化、智能化也成为智慧医院建设的新特性。由于诊疗需求的日益增长，临床、服务及管理业务都存在亟需解决的问题，院区运行保障运行状况难以及时掌握，维护管理效率低，各个业务系统之间联动差；医院当前的各项资源利用率低，难以完成预期诊疗目标；医生、护士、药师等多角色诊疗流程配合效率低，难以通过精益化管理提升医疗质量和患者服务体验；医疗数据质量差，不能直接被用以医学科研的研究。这些问题都对智慧医院建设提出新的挑战和要求。</P><H2>方案概述</H2><P class=MsoNormal>基于对医疗行业的理解和实践，新华三构建“医院数字大脑”：由智能数字平台（数字基础设施、业务能力平台、主动安全、统一运维），搭载合作伙伴N个生态应用构成，简称“4+N”。</P><P class=MsoNormal align=center><IMG id="图片 1" src="https://resource.h3c.com/cn/202208/11/20220811_7610392_image001_1664075_473305_0.png" width=554 height=264></P><P class=MsoNormal>总体遵循面向医院业务需求的设计思路，基于医院业务特性，通过智能计算存储、智能网络、智能边缘、智能终端形成医院完整的数字基础设施体系，为医院临床、服务及运营管理业务提供稳固的运行“基石”。医疗业务能力平台可实现医院多源异构数据的采集、治理和分析，运用AI、大数据、物联网、智能视觉等能力构建医院数字中台体系，为智慧医疗、智慧服务及智慧管理提供标准化的数据服务，支撑医院临床辅助、智能导诊、运营决策及医学科研等应用系统的全面建设。面向医院的安全防护以及等保三级的要求，也有完备的主动安全方案。由于医院设备种类繁多，对运维的要求也很高，同时也为医院提供全场景统一运维方案和服务。</P><P class=MsoNormal>新华三智慧医院解决方案采用成熟、具有国内先进水平，符合医疗行业发展趋势的技术、软件和设备，积极吸纳了业界最新的架构思想和建设理念，在设计过程中充分依据国际、国内的各项技术、业务和数据规范标准。</P><H2>方案亮点</H2><P class=MsoNormal><B>1. </B><B>整体顶层规划架构设计，可持续发展</B></P><P class=MsoNormal align=left>整体顶层规划架构设计是信息化建设的灵魂和基础。同时根据IT技术和医院信息化发展趋势、系统的开放性、扩展性、业务敏捷性等，统筹建设可持续发展顶层规划模型。适应未来新技术的变化，适应未来不断发展的业务，同时也能够支撑医院规模的扩大。满足对业务变化的适应能力和未来信息化扩展。</P><P class=MsoNormal><B>2. </B><B>建设医院数字大脑，遵从行业标准规范</B></P><P class=MsoNormal align=left>医院数字大脑建设，结合国家相关政策和法规，在医院信息化建设中，整合标准规范，建设全院统一的信息化标准，包括术语规范、业务规范、技术规范、数据规范、接口规范、运维管理规范等。以《三级综合医院评审标准（2020版）》、《三级综合医院评审标准实施细则(2013年版)》为基础功能要求，以《电子病历系统功能应用水平分级评价方法及标准（2018）》、《医院信息互联互通标准化成熟度测评方案（2020版）》、《医院智慧服务分级评估标准体系（试行）》、《医院智慧管理分级评估体系（试行）》为建设蓝本，构建全院标准化信息建设体系。</P><P class=MsoNormal><B>3. </B><B>融合集成，服务医院运行保障一体化智能管理</B></P><P class=MsoNormal>通过医疗业务能力平台南向对接多种异构信息化系统，包括后勤、能效、楼宇及安防等子系统，实现系统互联、数据共享，全面服务医院运行保障一体化智能管理。</P><P class=MsoNormal><B>4. </B><B>构建新型智慧运营管理中心和科研大数据平台</B></P><P class=MsoNormal>结合物联网技术，以可视化、智能化、网络化、集成化理念为目标，全面展示医院综合态势、运营态势、医疗业务态势及患者服务态势等全方位数据。通过数据采集、治理、分析形成医院科研大数据平台，助力医院学科建设和发展。</P><H2>客户价值</H2><P class=MsoNormal align=left><B>1. </B><B>全域集成，统一管控</B></P><P class=MsoNormal align=left>通过医疗业务能力平台打通医疗、楼宇、安防、消防、后勤、能效等业务域，沉淀用户业务和管理数据并形成高质量全域贴源数据湖，将数据资产真正还给医院。基于数据湖建设的智慧管理运营中心全面展示医疗业务、院区运营指标及总体态势，达到实时掌握运营情况、全院管控一张图的效果。</P><P class=MsoNormal align=left><B>2. </B><B>赋能医院管理，实现最大效益</B></P><P class=MsoNormal align=left>以全业务域数据为基础，结合管理方法论，赋予数据管理属性，运用医院自身数据，驱动医院自身高效管理体系建设。帮助医院实现社会效益、经济效益最大化，重塑医院全价值链，提升医院社会影响力和竞争力。</P><P class=MsoNormal align=left><B>3. </B><B>百亿数据秒级响应，重塑医院管理新模式</B></P><P class=MsoNormal>面对医院实现精益化管理的需求，通过大数据技术快速实现多业务维度、大时间跨度管理指标的综合计算，使能医院管理决策科学化、智能化，赋能医院精益化管理，实现百亿条数据中检索秒级响应的效果，重塑医院管理新模式。</P><H2>最佳实践</H2><H4>四川大学华西医院</H4><P class=MsoNormal>四川大学华西医院，中国医院综合排行榜第二，连续6年位居中国医院科技影响力排行榜榜首。新华三智慧医院数字大脑解决方案，以整体能力服务于华西医院智慧管理项目建设。</P><P class=MsoNormal>智慧医院数字大脑解决方案以全域数据全场景多维度数据开发、数据治理能力，形成高价值的数据资产和数据仓库，打破传统数据应用困局，建设一站式应用模式，提高医疗质量，优化资源配置，时效提升百倍。为医院提供精准医疗和辅助决策支持，大幅提升管理、科研工作效率，帮助医院管理从数据辅助决策迈向智能仿真决策时代。</P><P class=MsoNormal></P><P class=MsoNormal></P></DIV> </DIV>
<!-- content End -->
