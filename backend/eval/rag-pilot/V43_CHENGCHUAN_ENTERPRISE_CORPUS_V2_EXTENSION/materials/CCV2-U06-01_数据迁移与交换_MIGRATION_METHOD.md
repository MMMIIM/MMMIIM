---
doc_id: "CCV2-U06-01"
title: "数据迁移与交换-MIGRATION_METHOD"
...
matrix_theme: "U06"
evidence_slot: "MIGRATION_METHOD"
...
1. 澄川数据治理平台 XDG 4.1迁移工具支持CSV、Excel、JDBC数据源和SFTP文件四类输入。
2. 迁移作业支持全量、按时间字段增量和按主键范围分批三种方式。
3. 迁移前执行字段类型检查、必填检查和主键重复检查。
4. 迁移异常记录包含源记录定位信息和失败原因。
