---
doc_id: "CCV2-U11-01"
title: "日志审计与可追溯-AUDIT_CAPABILITY"
...
matrix_theme: "U11"
evidence_slot: "AUDIT_CAPABILITY"
...
1. 澄川安全审计中心 XSA 2.8记录登录、权限变更、数据导出、配置修改和管理员操作日志。
2. 审计日志包含用户、时间、来源IP、操作对象、动作和结果字段。
3. 审计日志默认在线保留180天，归档保留期可按项目配置。
4. 业务管理员无权删除审计归档文件。
