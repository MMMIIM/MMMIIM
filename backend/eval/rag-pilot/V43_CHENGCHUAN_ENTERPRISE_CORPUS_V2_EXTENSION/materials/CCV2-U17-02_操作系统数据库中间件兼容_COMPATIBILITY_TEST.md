---
doc_id: "CCV2-U17-02"
title: "操作系统数据库中间件兼容-COMPATIBILITY_TEST"
...
matrix_theme: "U17"
evidence_slot: "COMPATIBILITY_TEST"
...
# 操作系统数据库中间件兼容-COMPATIBILITY_TEST
...
1. 2026-06兼容性测试在PostgreSQL 16与RabbitMQ 3.12组合完成回归。
2. 数据库切换后执行核心业务用例212项，通过212项。
3. 达梦DM8组合执行186项，通过184项，2项SQL兼容问题修复后复测通过。
4. 兼容测试结果必须与产品版本和依赖版本共同使用。
