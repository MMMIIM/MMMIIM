---
doc_id: "CCV2-U32-02"
title: "知识产权授权与许可-AUTHORIZATION_RECORD"
...
matrix_theme: "U32"
evidence_slot: "AUTHORIZATION_RECORD"
...
# 知识产权授权与许可-AUTHORIZATION_RECORD
...
1. Synthetic授权书AUTH-2026-DB允许SYNTH-CHENGCHUAN-001在2026年度测试项目中使用某数据库适配组件。
2. 授权有效期为2026-01-01至2026-12-31。
3. 授权书不包含转授权权利。
4. 授权过期后必须重新核验。
