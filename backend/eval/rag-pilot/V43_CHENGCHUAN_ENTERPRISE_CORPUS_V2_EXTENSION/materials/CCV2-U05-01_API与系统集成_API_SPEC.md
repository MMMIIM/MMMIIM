...
1. 澄川集成网关 XIG 3.6支持REST、SOAP、HTTP回调和SFTP文件交换四类集成方式。
2. 接口可配置请求头映射、字段映射、签名校验、限流和超时策略。
3. API访问凭据按调用方独立分配并支持停用。
4. 接口定义可导入OpenAPI 3.0格式文档。
