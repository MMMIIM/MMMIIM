---
doc_id: "CCV2-U12-02"
title: "监控告警与运行保障-ALARM_RESPONSE_RECORD"
...
matrix_theme: "U12"
evidence_slot: "ALARM_RESPONSE_RECORD"
...
# 监控告警与运行保障-ALARM_RESPONSE_RECORD
...
1. 2026-07运行记录共触发测试告警286次。
2. P1级测试告警平均确认时间为6分12秒，P2级为18分40秒。
3. 3次通知通道故障均由备用Webhook通道成功发送。
4. 这些统计属于内部演练，不构成对客户项目的固定响应时间承诺。
