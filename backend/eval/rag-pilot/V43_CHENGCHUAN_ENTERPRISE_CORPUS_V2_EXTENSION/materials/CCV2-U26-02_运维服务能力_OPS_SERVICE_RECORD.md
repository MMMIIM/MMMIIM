---
doc_id: "CCV2-U26-02"
title: "运维服务能力-OPS_SERVICE_RECORD"
...
matrix_theme: "U26"
evidence_slot: "OPS_SERVICE_RECORD"
...
1. 2026-Q2内部支持工单共412单。
2. 其中故障类96单、咨询类214单、配置变更类102单。
3. 96个故障工单全部记录根因分类，重复故障17单进入问题管理。
4. 这些内部统计不能自动转化为客户SLA承诺。
