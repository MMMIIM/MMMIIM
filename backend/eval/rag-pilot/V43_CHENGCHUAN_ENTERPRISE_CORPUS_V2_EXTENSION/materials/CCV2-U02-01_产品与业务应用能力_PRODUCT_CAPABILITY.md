---
doc_id: "CCV2-U02-01"
title: "产品与业务应用能力-PRODUCT_CAPABILITY"
...
matrix_theme: "U02"
evidence_slot: "PRODUCT_CAPABILITY"
...
1. 澄川政企数字平台 XDP 5.2包含统一门户、工作台、流程编排、消息中心、组织用户管理和应用接入模块。
2. 澄川政企数字平台 XDP 5.2的流程编排模块支持串行、并行、条件分支和人工审批节点。
3. 澄川政企数字平台 XDP 5.2的多租户能力采用租户级数据隔离，默认不允许跨租户查询。
4. 产品功能目录版本为XDP-CAP-5.2-2026Q2。
