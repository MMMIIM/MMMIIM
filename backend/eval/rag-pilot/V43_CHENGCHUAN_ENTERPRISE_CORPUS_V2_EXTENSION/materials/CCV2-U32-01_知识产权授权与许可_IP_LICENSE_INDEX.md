---
doc_id: "CCV2-U32-01"
title: "知识产权授权与许可-IP_LICENSE_INDEX"
...
requirement_themes: ["U32"]
matrix_theme: "U32"
evidence_slot: "IP_LICENSE_INDEX"
...
# 知识产权授权与许可-IP_LICENSE_INDEX

## 记录对象

本记录属于澄川数智科技有限公司（Synthetic Demo Company）的受控开发企业材料，面向知识产权授权与许可主题。

## 可核验记录

1. 软件著作权测试索引记录XDP、XIG、XDG、XSA四个产品对应的Synthetic登记编号。
2. 第三方开源组件许可证清单随产品版本发布。
3. 商业第三方组件授权范围按项目采购许可证核验。
4. 知识产权索引不证明投标人拥有第三方软件所有权。
