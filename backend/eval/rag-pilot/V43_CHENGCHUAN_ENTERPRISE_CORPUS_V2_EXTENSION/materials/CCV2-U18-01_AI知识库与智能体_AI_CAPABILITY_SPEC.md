---
doc_id: "CCV2-U18-01"
title: "AI知识库与智能体-AI_CAPABILITY_SPEC"
...
matrix_theme: "U18"
evidence_slot: "AI_CAPABILITY_SPEC"
...
1. 澄川智能知识平台 XAI 2.3支持文档入库、向量检索、关键词检索、混合召回和知识问答。
2. 知识库按空间隔离，不同空间默认不能互相检索。
3. 智能体工具调用必须配置白名单工具。
4. AI回答可携带来源片段标识。
